...
WORDLIST_FILENAME = "/Users/jingchen/Documents/2019_CSLearning/Python/Python2/DONE+PASSED-edx-MIT6.00.1x-IntroToComputerScience+ProgrammingUsingPython/ProblemSet4/ProblemSet4/words.txt"
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(lefthand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(word, lefthand, wordList) == False:
            ...
            # Otherwise (the word is valid):
                ...
                score = getWordScore(word, n) + score
    ...
    if calculateHandlen(lefthand)>0:
